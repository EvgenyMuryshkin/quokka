    ...
    public static class Branch_Switch
    {
            ...
            )
        {
            Action handler = () =>
            {
                ...
                byte result = 0;
                Controllers.Branch_Switch.TestMethod(data, out result);
    ...
    public static class Branch_IfElse
    {
            ...
            )
        {
            Action handler = () =>
            {
                ...
                byte result = 0;
                Controllers.Branch_IfElse.TestMethod(data, out result);
    ...
    public static class Branch_Switch_IfElse_Break
    {
            ...
            )
        {
            Action handler = () =>
            {
                ...
                byte result = 0;
                Controllers.Branch_Switch_IfElse_Break.TestMethod(data, out result);
