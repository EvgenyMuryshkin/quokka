...
namespace System
{
    ...
    {
        public static TimeSpan FromMicroseconds(ulong microseconds)
        {
            return TimeSpanEx.FromNanoseconds(microseconds * 1000);
        }

        public static TimeSpan FromNanoseconds(ulong nanoseconds)
        {
